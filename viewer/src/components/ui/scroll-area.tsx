...
function ScrollArea({
  ...
  return (
    ...
    >
      ...
      >
        {/* Content observes size — remeasures when accordion collapses so overflow/scrollbar clear. */}
...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.Scrollbar
      ...
      className={cn(
        // Auto-hide (Base UI docs): visible only while hovering the area or scrolling.
        // keepMounted defaults false → unmount when no overflow.
        "flex touch-none p-px select-none opacity-0 transition-opacity pointer-events-none",
